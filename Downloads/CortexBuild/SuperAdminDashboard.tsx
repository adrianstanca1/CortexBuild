...
import { Users, Building2, Activity, Database, TrendingUp, AlertCircle, FileText, BarChart3, Code, Package, Zap, Webhook, Grid, Star, Cpu, Shield, HardDrive, GitBranch } from 'lucide-react';
...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'companies' | 'system' | 'analytics' | 'logs' | 'developer' | 'marketplace' | 'dashboards' | 'sdk' | 'automation' | 'webhooks' | 'reviews' | 'sdk-env' | 'access-control' | 'usage-monitoring' | 'database-manager' | 'workflow-builder'>('overview');
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      {activeTab === 'workflow-builder' && <WorkflowCanvas />}
