...
router.patch('/users/:id/access', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.patch('/users/:id/tier', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { tier } = req.body;
...
router.get('/usage', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
...
router.get('/usage/by-user', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
...
router.get('/usage/recent', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
...
router.get('/usage/export', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    const { range = '7d' } = req.query;
...
router.get('/database-stats', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    // Get database size
...
router.get('/company-quotas', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
...
router.get('/user-quotas', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    const quotas = db.prepare(`
      SELECT 
        u.id as user_id,
...
router.post('/database-backup', authenticateToken, checkSuperAdmin, async (req: Request, res: Response) => {
  try {
    const fs = require('fs');
