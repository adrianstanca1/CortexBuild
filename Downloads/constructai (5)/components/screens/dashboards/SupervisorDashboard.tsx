...
import type { User, Screen, Task, ActivityEvent, Project } from '../../../types.ts';
// Fix: Added .ts extension to import
...
import type { DashboardData } from '../../../utils/dashboardLogic.ts';
import { processDashboardData } from '../../../utils/dashboardLogic.ts';
