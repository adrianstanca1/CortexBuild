...
import { Sparkles, Code, Eye, Save, Play, Download, MessageSquare, CheckCircle, AlertTriangle, TestTube } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="bg-gray-800 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white font-semibold">Generated Code</span>
            </div>
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <span>{generatingTests ? 'Generating...' : 'Tests'}</span>
              </button>
            </div>
          </div>
