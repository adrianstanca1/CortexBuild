      ...
      {healthStatus && (
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="flex items-center">
              <div className={`w-3 h-3 rounded-full mr-2 ${healthStatus.api === 'healthy' ? 'bg-green-500' : 'bg-red-500'}`} />
              <span className="text-sm text-gray-600">API: {healthStatus.api}</span>
            </div>
            <div className="flex items-center">
              <div className={`w-3 h-3 rounded-full mr-2 ${healthStatus.database === 'healthy' ? 'bg-green-500' : 'bg-red-500'}`} />
