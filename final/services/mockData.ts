...
export const initialData = {
    ...
    users: [
        { id: 'demo', firstName: 'Demo', lastName: 'User', email: 'demo@example.com', role: Role.ADMIN, companyId: '1', avatar: 'https://i.pravatar.cc/150?u=demo', password: 'password', mfaEnabled: false },
