...
const LoginForm: React.FC<LoginFormProps> = React.memo(({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validation = combineValidations(validateEmail(email), validatePassword(password));
        ...
        <div className="flex">
          <div className="flex-shrink-0">
            ...
            >
              <path
                fillRule="evenodd"
                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A.75.75 0 0010.747 15l.001-.001a.75.75 0 00.746-.894l.459-2.066A1.75 1.75 0 009.253 9H9z"
                clipRule="evenodd"
              />
            </svg>
          </div>
          <div className="ml-3">
            <p className="text-sm text-purple-700 font-semibold mb-1">🚀 Platform Admin Access</p>
            <p className="text-sm text-purple-700">
              Email: <code className="font-bold">adrian.stanca1@gmail.com</code>
              <br />
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              Demo Users: <code className="font-bold">casey@constructco.com</code> or{' '}
              <code className="font-bold">susan@constructco.com</code>. Password:{' '}
