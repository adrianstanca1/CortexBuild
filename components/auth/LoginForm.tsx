                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className="text-sm text-blue-700">
                            Demo Users: <code className="font-bold">adrian@ascladdingltd.co.uk</code> (Company Admin) or <code className="font-bold">dev@constructco.com</code> (Developer). Passwords: <code className="font-bold">Lolozania1</code> and <code className="font-bold">parola123</code>.
                        </p>
                    </div>
                </div>
            </div>
